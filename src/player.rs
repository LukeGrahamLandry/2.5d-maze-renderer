...
use crate::entity::{DynamicWall, SquareEntity};
...
impl<'map, 'portals> Player<'map, 'portals> {
    ...
    pub(crate) fn update(&mut self, pressed: &Vec<Keycode>, delta_time: f64, delta_mouse: i32) -> bool {
    ...
    pub(crate) fn handle_collisions(&mut self, mut move_direction: Vector2) -> Vector2 {
        ...
        let mut wall = None;
        for check_wall in self.entity.region.walls() {
                ...
                if hit_back || hit_edge {
                    ...
                    match wall.portal() {
                        ...
                        Some(portal) => {
                            ...
                            self.entity.region = portal.to_wall.region();

                            self.entity.pos = portal.translate(self.entity.pos);
                            self.look_direction = portal.rotate(self.look_direction);
